...
FROM spends GROUP BY month ORDER BY month;
```
...
```sql
SELECT supplier_id,SUM(amount) FROM spends
...
INSERT INTO spends (transaction_no, supplier_inv_no, description, amount, date)
VALUES (38104091, 3780119655, 'Computer Hardware Dell', 32000, '2021-08-19');
```
